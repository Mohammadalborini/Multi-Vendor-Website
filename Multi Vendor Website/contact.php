...
if (!isset($_SESSION["lang"])) { $_SESSION["lang"] = "en";  header("Location: contact.php");}
if (isset($_POST["lang"])) { $_SESSION["lang"] = $_POST["lang"];  header("Location: contact.php");}

require "lang/contact-".$_SESSION["lang"].".php";
                  ...
                  <li class="col-3">
                                    ...
                                    <li class="col-12 mt-4">
                                        ...
                                        <?php 
                                            ...
                                            ?>
                                            <img class="w-100" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($image4); ?>" style="width:1009px; height:208px;" alt="img">
                                        </a>
                                    </li>
                  </ul>
                </li>
...
<nav class="breadcrumb-section theme1 breadcrumb-bg1" style="
        background-image: url('data:image/jpg;charset=utf8;base64,<?php echo base64_encode($image4); ?>')">
  <div class="container">
    <div class="row">
      <div class="col-12">
...
?>
<!-- map start -->
<div class="map" style=" position:static; text-align:center">
<?php echo $location;?>
</div>
<!-- map end -->
    ...
    <div class="row">
      <div class="col-lg-6 col-12 mb-30">
        ...
        <div class="contact-page-side-content">
          <h3 class="contact-page-title"><?php echo $title ?></h3>
          <p class="contact-page-message mb-30"><?php echo $description ?></p>
          <!--  single contact block  -->

          <div class="single-contact-block">
            <h4><i class="fa fa-fax"></i> <?= $_TXT[72]; ?></h4>
          ...
          <div class="single-contact-block">
            <h4><i class="fa fa-phone"></i> <?= $_TXT[73]; ?></h4>
            <?php  $pieces = explode("/", $phone);
          for ($i=0; $i<count($pieces); $i++){
            echo '
            <p>
            
              <a href="'.$pieces[$i].'">'.$pieces[$i].'</a>
            </p>
            ';
          } ?>
          ...
          <div class="single-contact-block">
            <h4><i class="fas fa-envelope"></i> <?= $_TXT[74]; ?></h4>
      ...
      <div class="col-lg-6 col-12 mb-30">
        ...
        <div class="contact-form-content">
          <h3 class="contact-page-title"><?= $_TXT[75]; ?></h3>
          <div class="contact-form">
            <form id="contact-form" action="assets/php/mail.php" method="post">
              <div class="form-group">
                <label><?= $_TXT[76]; ?> <span class="required">*</span></label>
                <input type="text" name="customerName" id="customername" required="">
              </div>
              <div class="form-group">
                <label><?= $_TXT[77]; ?> <span class="required">*</span></label>
