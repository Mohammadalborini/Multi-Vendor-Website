...
$store_name = $_GET['store-name'];
$rele = $_GET['rele'];


if (!isset($_SESSION["lang"])) { $_SESSION["lang"] = "en"; header("Location: shop-grid-4-column-store.php?id_store=$id_store&store-name=$store_name&rele=$rele");}
if (isset($_POST["lang"])) { $_SESSION["lang"] = $_POST["lang"];  header("Location: shop-grid-4-column-store.php?id_store=$id_store&store-name=$store_name&rele=$rele");}

require "lang/shop-grid-4-column-store-".$_SESSION["lang"].".php";
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="breadcrumb-title text-center my-20">
                    <h2 class="title text-dark text-capitalize"><?php echo $store_name1; ?></h2>
                </div>
            </div>
            <div class="col-12">
                <ol class="breadcrumb bg-transparent m-0 p-0 align-items-center justify-content-center">
                    <li class="breadcrumb-item"><a href="index1.php"><?= $_TXT[67]; ?></a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $store_name1; ?></li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-0">
                    <nav class="shop-grid-nav">
                        <ul class="nav nav-pills align-items-center" id="pills-tab" role="tablist">
                            ...
                            <?php $sum = '';
                              $id_store = $_GET['id_store'];
                              $query="SELECT * from orders where store_id = '$id_store'";
                              $result = mysqli_query($conn,$query);
                              $sum = mysqli_num_rows($result);?>
                            <li> <span class="total-products text-capitalize"><?= $_TXT[68]; ?> <?php echo $sum; ?> <?= $_TXT[69]; ?></span></li>
                        </ul>
                    </nav>
                </div>
                <div class="col-12 col-md-6 position-relative">
                    <div class="shop-grid-button d-flex align-items-center">
                        <span class="sort-by"><?= $_TXT[70]; ?></span>
                        <button class="btn-dropdown d-flex justify-content-between" type="button"
                            id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <?= $_TXT[71]; ?> <span class="ion-android-arrow-dropdown"></span>
                        </button>
                        <div class="dropdown-menu shop-grid-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="shop-grid-4-column-store.php?id_store=<?php echo $id_store; ?>&store-name=<?php echo $store_name1; ?>&rele=rele"><?= $_TXT[71]; ?></a>
                            <a class="dropdown-item" href="shop-grid-4-column-store.php?id_store=<?php echo $id_store; ?>&store-name=<?php echo $store_name1; ?>&rele=rele"> <?= $_TXT[72]; ?></a>
                            <a class="dropdown-item" href="shop-grid-4-column-store.php?id_store=<?php echo $id_store; ?>&store-name=<?php echo $store_name1; ?>&Price=ASC"> <?= $_TXT[73]; ?></a>
                            <a class="dropdown-item" href="shop-grid-4-column-store.php?id_store=<?php echo $id_store; ?>&store-name=<?php echo $store_name1; ?>&Price=DESC"> <?= $_TXT[74]; ?></a>
                            <a class="dropdown-item" href="shop-grid-4-column-store.php?id_store=<?php echo $id_store; ?>&store-name=<?php echo $store_name1; ?>&rate=ASC"> <?= $_TXT[75]; ?></a>
                            <a class="dropdown-item" href="shop-grid-4-column-store.php?id_store=<?php echo $id_store; ?>&store-name=<?php echo $store_name1; ?>&rate=DESC"> <?= $_TXT[76]; ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php if (isset($_GET['rele'])): ?>
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                ...
                <?php  
                    ...
                    while ($row = mysqli_fetch_assoc($result)):
                    $id = $row['id'];
                    $store_name = $row[$_TXT[66]];
                    $store_logo = $row['store_logo'];
                    $product_name = $row['product_name'];
                    $product_name1 = $row[$_TXT[77]];
                            ...
                            <div class="card-body p-0">
                                <div class="product-thumbnail position-relative">
                                  ...
                                  $uploaded_on = date_create($uploaded_on);
                                    ...
                                    <a href="single-product-configurable.php?id_store=<?php echo $id_store?>&id_product=<?php echo $id;  ?>&storename=<?php echo $store_name; ?>">
                                        <?php
                                    ...
                                    <div class="product-links d-flex d-flex justify-content-between">
                                            <ul class="d-flex justify-content-center">
                                                ...
                                                <li>
                                                    <a href="wishlist.php?id_store=<?php echo $id_store; ?>&id_product=<?php echo $id; ?>" tabindex="0">
                                ...
                                <div class="product-desc">
                                    ...
                                    <?php
                             if (!($discount) == null) {
                               echo '<h6 class="product-price"><del class="del">'.$product_price.' '.$_TXT[78].'</del>
                               <span class="onsale">'.$discount.' '.$_TXT[78].'</span></h6>';
                            }else {
                                echo '<h6 class="product-price"> <span class="onsale">'.$product_price.' '.$_TXT[78].'</span></h6>';
                            }
                            ?>
    ...
    <?php else: echo '<h6 class="product-price"> <span class="onsale">'.$_TXT[79].'</span></h6>'; ?>
<?php endif;?>
...
<div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                ...
                <?php  
                    $id_store = $_GET['id_store'] ;
                    $query="SELECT * from orders where store_id = '$id_store' ORDER BY product_price $Price ";
                    $result = mysqli_query($conn,$query);
                    if (mysqli_num_rows($result) > 0):
                        $sum = mysqli_num_rows($result);
                    while ($row = mysqli_fetch_assoc($result)):
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 mb-30">
                        <div class="card product-card">
                            <div class="card-body p-0">
                                ...
                                <div class="product-desc">
                                    <h3 class="title"><a href="single-product-configurable.php?id_store=<?php echo $id_store?>&id_product=<?php echo $id;  ?>&storename=<?php echo $store_name; ?>"><?php echo $product_name1; ?></a></h3>
                                    <div class="star-rating my-10">
                                    <?php
                                                  $query10="SELECT * from review where id_product='$id' ";
                                                  $result10 = mysqli_query($conn,$query10);
    ...
    <?php else: echo '<h6 class="product-price"> <span class="onsale">There is no product </span></h6>'; ?>
<?php endif;?>
...
<div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                ...
                <?php  
                    ...
                    $query="SELECT * from orders where store_id = '$id_store'  ORDER BY rate $rate ";
                    $result = mysqli_query($conn,$query);
                    if (mysqli_num_rows($result) > 0):
                        $sum = mysqli_num_rows($result);
                    while ($row = mysqli_fetch_assoc($result)):
...
<!---------------------------------------------------------with filter rate end------------------------------------------------------------------------------------->
            ...
            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                ...
                <?php  
                    ...
                    $store_logo = $row['store_logo'];
                    $product_name = $row['product_name'];
                    $short_description = $row[$_TXT[80]];
                    $uploaded_on = $row['uploaded_on'];
                    $product_price = $row['product_price'];
                    $discount = $row['discount'];

                    $full_description = $row[$_TXT[81]];
                    $product_material = $row[$_TXT[82]];
                                ...
                                <div class="media flex-column flex-sm-row">
                                  ...
                                  $uploaded_on = date_create($uploaded_on);
                                    ...
                                    <div class="media-body pl-sm-4 mt-30 mt-sm-0">
                                        <div class="product-desc">
                                        <h3 class="title"><a href="single-product-configurable.php?id_store=<?php echo $id_store?>&id_product=<?php echo $id;  ?>&storename=<?php echo $store_name; ?>"><?php echo $product_name; ?></a></h3>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5 class="title"> added to compare?</h5>
                <a href="">Click here</a>
            </div>
        </div>
    </div>
