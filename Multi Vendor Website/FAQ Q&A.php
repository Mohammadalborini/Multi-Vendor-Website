...
if (!isset($_SESSION["lang"])) { $_SESSION["lang"] = "en";  header("Location: FAQ Q&A.php");}
if (isset($_POST["lang"])) { $_SESSION["lang"] = $_POST["lang"];  header("Location: FAQ Q&A.php");}

require "lang/FAQ Q&A-".$_SESSION["lang"].".php";
...
<nav class="breadcrumb-section theme1 breadcrumb-bg1" style="
        background-image: url('data:image/jpg;charset=utf8;base64,<?php echo base64_encode($image5); ?>')">
  <div class="container">
    <div class="row">
      <div class="col-12">
...
<section class="about-section pb-40">
    <div class="container grid-wraper">
      ...
      <main>
        <h1 class="faq-heading" style="text-align:<?= $_TXT[72]; ?>;"><?= $_TXT[69]; ?></h1>
        ...
        <?php  
            ...
            if (mysqli_num_rows($result) > 0):
            while ($row = mysqli_fetch_assoc($result)):
            $question = $row[$_TXT[70]];
            $answer = $row[$_TXT[71]];
            ?>
            <div class="faq-one" >
                <!-- faq question -->
                <h1 class="faq-page" style="font-size: 30px; font-weight: 700; text-align:<?= $_TXT[72]; ?>;"><?php echo $question ?></h1>
                <!-- faq answer -->
                <div class="faq-body">
                    <p style="text-align:<?= $_TXT[72]; ?>;"><?php echo $answer ?></p>
                    <?php
