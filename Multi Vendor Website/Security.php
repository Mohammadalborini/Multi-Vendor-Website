...
if (!isset($_SESSION["lang"])) { $_SESSION["lang"] = "en";  header("Location: Security.php");}
if (isset($_POST["lang"])) { $_SESSION["lang"] = $_POST["lang"];  header("Location: Security.php");}

require "lang/Security-".$_SESSION["lang"].".php";
...
<nav class="breadcrumb-section theme1 breadcrumb-bg1" style="
        background-image: url('data:image/jpg;charset=utf8;base64,<?php echo base64_encode($image6); ?>')">
  <div class="container">
    <div class="row">
      <div class="col-12">
...
<section class="about-section pb-40">
    <div class="container grid-wraper">
        <div class="row">
        <?php  
            $query="SELECT * from security_info limit 1";
            $result = mysqli_query($conn,$query);
            if (mysqli_num_rows($result) > 0):
            while ($row = mysqli_fetch_assoc($result)):
            $title1 = $row[$_TXT[69]];
            ...
            <div class="col-lg-6 mb-30">
                <div class="about-content">
                    <h2 class="title mb-20"><?php echo $title1; ?></h2>
                    <p class="mb-20">
        ...
        <?php  
            $query="SELECT * from security_image limit 1";
            $result = mysqli_query($conn,$query);
            if (mysqli_num_rows($result) > 0):
            while ($row = mysqli_fetch_assoc($result)):
                $image1 = $row['image'];
            ...
            <div class="col-lg-6 mb-30">
                <div class="about-left-image mb-30">
                    <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($image1); ?>" alt="img" class="img-responsive">
                </div>
            </div>
            <?php endwhile;?>
        <?php endif;?>
        ...
        <div class="row">
        <?php  
            $query="SELECT * from security_info WHERE id != 1";
            $result = mysqli_query($conn,$query);
            if (mysqli_num_rows($result) > 0):
            while ($row = mysqli_fetch_assoc($result)):
              $title1 = $row[$_TXT[71]];
              $description1 = $row[$_TXT[72]];
            ?>
            <div class="col-md-4 mb-30">
                <div class="about-info">
                    <h4 class="title mb-20"><?php echo $title1; ?></h4>
                    <p>
                    <?php echo $description1; ?>
                    </p>
                </div>
