...
if (!isset($_SESSION["lang"])) { $_SESSION["lang"] = "en"; header("Location: Your_Orders.php");}
if (isset($_POST["lang"])) { $_SESSION["lang"] = $_POST["lang"];  header("Location: Your_Orders.php");}

require "lang/Your_Orders-".$_SESSION["lang"].".php";
                ...
                <div class="table-responsive">
                    <table class="table mb-0">
                        <thead class="thead-light">
                            <tr>
                                <th class="text-center" scope="col"><?= $_TXT[68]; ?></th>
                                <th class="text-center" scope="col"><?= $_TXT[69]; ?></th>
                                <th class="text-center" scope="col"><?= $_TXT[70]; ?></th>
                                <th class="text-center" scope="col"><?= $_TXT[71]; ?></th>
                                <th class="text-center" scope="col"><?= $_TXT[72]; ?></th>
                                <th class="text-center" scope="col"><?= $_TXT[73]; ?></th>
                        ...
                        <?php
                                if(!isset($_SESSION['id1'])){
                                    ...
                                    $i=1;
                                    $id1 = $_SESSION['id1'];
                                    $query2="SELECT * from user_product where id_user = '$id1' ";
                                    $result2 = mysqli_query($conn,$query2);
                                    if (mysqli_num_rows($result2) > 0){
                                    while ($row1 = mysqli_fetch_assoc($result2)){
                                        $product_name = $row1[$_TXT[76]];
                                        $store_name = $row1[$_TXT[77]];
                                        $store_image = $row1['store_image'];
                                        $order_status = $row1[$_TXT[78]];
                                        $total = $row1['total'];
                                        $qty = $row1['qty'];
                        ...
                        <tbody>
                            <tr>
                                <th class="text-center" scope="row">
                                    <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_decode($store_image); ?>" alt="img">
                                </th>
                                ...
                                <td class="text-center">
                                    <div class="product-count style">
                                        <div class="count d-flex justify-content-center">
                                            <input type="number" min="1" max="10" step="1" value="<?php echo $qty; ?>" disabled>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <span class="whish-list-price">
                                        <?php echo $total; ?> <?= $_TXT[79]; ?>
                                    </span></td>
