...
if (!isset($_SESSION["lang"])) { $_SESSION["lang"] = "en";  header("Location: login.php");}
if (isset($_POST["lang"])) { $_SESSION["lang"] = $_POST["lang"];  header("Location: login.php");}
...
<div class="my-account pb-70">
    <div class="container grid-wraper">
        <div class="row">
            <div class="col-12">
                <h3 class="title text-capitalize pb-30"> <?= $_TXT[69]; ?></h3>
                <form class="log-in-form" action="login-process.php" method="POST">
                    <div class="form-group row">
                        <label for="staticEmail" class="col-md-3 col-form-label"><?= $_TXT[70]; ?></label>
                        <div class="col-md-6">
                            <input type="text" name="username" class="form-control" id="staticEmail" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputPassword" class="col-md-3 col-form-label"><?= $_TXT[71]; ?></label>
                        <div class="col-md-6">
                            <div class="input-group mb-2 mr-sm-2">
                                <input type="password" name="password" class="form-control" id="inputPassword">
                                <div class="input-group-prepend">
                                    <button type="button"
                                        class="input-group-text  theme-btn--dark1 btn--md show-password" onclick="myreFunction()"><?= $_TXT[72]; ?></button>
                                </div>
                            </div>
                 ...
                 <label style="position: relative; left: 34%; color: #000; font-size: 20px; font-weight: bold;">   <?= $_TXT[73]; ?></label>

                 <div class="container">
                  <div class="row">
                    <div class="col">
                      <a href="#" class="fb btn">
                        <i class="fa fa-facebook fa-fw"></i> <?= $_TXT[74]; ?>
                       </a>
                    ...
                    <div class="form-group row pb-3 text-center">
                        <div class="col-md-6 offset-md-3">
                            <div class="login-form-links">
                                <a href="myaccount.php" class="for-get"><?= $_TXT[76]; ?></a>
                                <div class="sign-btn">
                                    <button name="submit" type="submit" class="btn theme-btn--dark1 btn--md"><?= $_TXT[77]; ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <p style="font-size:15px; color:red;" class="no-account"><?php echo $error; ?></p>
                    </div>
                        </div>
                    </div>
                  <?php
                    ...
                    <div class="form-group row text-center mb-0">
                        <div class="col-12">
                            <div class="border-top">
                                <a href="register.php" class="no-account"><?= $_TXT[78]; ?></a>
                            </div>
                        </div>
                    </div>
