      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Address and promo code</a>
          </div>
              ...
              <div class="col-md-12" >
                <div class="card" style="margin-top: 50px;">
                  <div class="card-header">
                    <h4 class="card-title"> Address and promo code </h4>
                  </div>
                  <div class="card-body" >
                    <div class="table-responsive" style="overflow: hidden;">
                    <?php
                     $result = $conn->query("SELECT * FROM address") or die($conn->error);
                   ?>
                      <table class="table" >
                      ...
                      <?php while ($row = $result->fetch_assoc()):  $id = $row['id'];?> 
                          ...
                          <?php echo $i;?>
                            ...
                            <td class="text-right">
                             <a href="edit_address.php?id=<?php echo $id; ?>" class="divs"> Edit</a><br>
                             <a href="address.php?id=<?php echo $id;?>" onclick="javascript: return confirm('Are you sure?');" class="divs" style="background:red;"> Delete</a>
                            </td>
                          </tr>
                          <?php $i++; ?>
                          <?php endwhile; ?>
