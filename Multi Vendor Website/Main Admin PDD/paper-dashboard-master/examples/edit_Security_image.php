...
if (isset($_GET['id'])){
  $id = $_GET['id'];
  $_SESSION['id'] = $id;
  $result = $conn->query("SELECT * FROM security_image WHERE id='$id' ") or die($conn->error);
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Security image section Information</h5>
              </div>
              <div class="divs">
                ...
                <label for="logo2" > Website logo </label><br>
                    ...
                    <input type="file" name="image" id="logo2"  required><p style="color: red;">* the size of image is 765*455</p>
...
if (isset($_POST['edit_header'])){
  ...
  if(!empty($_FILES["image"]["name"])) { 
      ...
      if( in_array($file_type, $allowed_file_types) ){ 
          ...
          $query = $conn->query("UPDATE security_image SET image='$img_content' WHERE id = $img_id");
          echo "<script> alert('Security image edited.') </script>";
