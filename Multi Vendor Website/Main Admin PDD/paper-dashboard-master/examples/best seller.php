      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">The best seller categories</a>
          </div>
                        ...
                        <tbody>
                          ...
                          <td>
                            ...
                            <td>
                              ...
                              ?>
                              <img src="../../../Admin Store PDD/material-dashboard-master/upload/<?php echo $piece[0]; ?>" style="width:100px; height:auto;">
                            </td>
                            <td>
                            <?php echo $product_name; ?>
                            </td>
                            <td>
                              <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($store_logo); ?>" style="width:100px; height:auto;">
                            </td>
                            <td>
        ...
        <div class="row">
          <div class="col-md-12">
              <div class="col-md-12" >
                <div class="card" style="margin-top: 50px;">
                  <div class="card-header">
                    <h4 class="card-title">Discount products</h4>
                  </div>
                  <div class="card-body" >
                    <div class="table-responsive" style="overflow: hidden;">
                      <table class="table" >
