      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Add Address and promo code</a>
          </div>
            ...
            <div class="card " style="margin-top: 50px;">
              <div class="divs" >
                <form action="" method="POST" enctype="multipart/form-data">
                  <label for="names" > Address and promo code </label><br>
                ...
                <label for="namea" >Promo code (not required)</label>
                    <input type="text" name="question2" id="namea" ><br>
...
if (isset($_POST['submit'])){
                ...
                $question2 = $_POST['question2'];
                 ...
                 $query = $conn->query("INSERT INTO `address`( `address`, `price`, `promo_code`) VALUES ('$question1','$ar_question1','$question2')");
                 echo "<script> alert('Address add.') </script>";
