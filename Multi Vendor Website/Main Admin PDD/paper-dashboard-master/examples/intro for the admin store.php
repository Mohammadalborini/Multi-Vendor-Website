                ...
                <h5 class="card-title">Upload video</h5>
                  ...
                  <div class="card-body" >
                    <div class="table-responsive" style="overflow: hidden;">
                      <table class="table" >
                      <?php
                     $result = $conn->query("SELECT * FROM upload_video") or die($conn->error);
                   ?>
                      ...
                      <?php while ($row = $result->fetch_assoc()):?> 
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <video src="../upload/<?php echo $row['viedo'];?>" width="320" height="240" controls>

                            </td>
                            <td class="text-right">
                             <a href="edit_intro for the admin store.php?id=<?php echo $row['id']; ?>" class="divs"> Edit</a>
                            </td>
                          </tr>
                        </tbody>
                        <?php $i++ ?>
