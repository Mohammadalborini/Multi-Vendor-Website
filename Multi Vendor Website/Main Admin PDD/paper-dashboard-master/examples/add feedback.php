            ...
            <div class="card">
              ...
              <div class="divs">
                ...
                <label for="logo2" > Image </label>
                  <input type="file" name="image" id="logo2" required><p style="color: red;">* the size of image is 100*100</p>
                ...
                <label for="nameo" > Name </label>
                    <input type="text" name="name3" id="nameo" required>
                <label for="link" > Email </label>
                    <input type="email" name="name4" id="link" required>
                <label for="link" > Feedback </label>
                  <textarea type="text" name="name5" id="link"></textarea>
                <label for="link" >Arabic Feedback </label>
                  <textarea type="text" name="name6" id="link"></textarea>
  
                    <input type="submit" value="Save" name="submit">
                    <a href="feedback.php" class="btn">Delete</a>
                </form>
              </div>
            </div>
          </div>
...
if (isset($_POST['submit'])){
  ...
  if(!empty($_FILES["image"]["name"])) { 
      ...
      if( in_array($file_type, $allowed_file_types) ){ 
          ...
          $query = $conn->query("INSERT INTO `feedback`( `title`, `ar_title`, `name`, `email`, `feedback`, `ar_feedback`, `image`) VALUES ('$name1','$name2','$name3','$name4','$name5','$name6','$img_content')");
          echo "<script> alert('Feddback add.') </script>";
            echo '<script> window.location.href = "feedback.php?name='.$name6.'"; </script>';
