...
if (isset($_GET['id'])){
  ...
  $result = $conn->query("SELECT * FROM footer WHERE id='$id' ") or die($conn->error);
    ...
    $_SESSION['ar_text'] =  $row['ar_text'];
    $_SESSION['url1'] =  $row['url1'];
    $_SESSION['url2'] =  $row['url2'];
    $_SESSION['url3'] =  $row['url3'];
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Footer section</a>
          </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Footer section Information</h5>
              </div>
              <div class="divs">
                ...
                <label for="logo2" > Website logo </label><br>
                    ...
                    <input type="file" name="image" id="logo2"  required><p style="color: red;">* the size of image is 127*27</p>

                  <label for="name" > Slogen </label>
                    <input type="text" name="name1" id="name" value="<?php echo $_SESSION['text']; ?>" required>
                  <label for="name" >Arabic Slogen </label>
                    <input type="text" name="name2" id="name" value="<?php echo $_SESSION['ar_text']; ?>" required>

                  <label for="name" >URL FACEBOOK </label>
                    <input type="text" name="name3" id="name" value="<?php echo $_SESSION['url1']; ?>" required>
                  <label for="name" >URL INSTAGRAM </label>
                    <input type="text" name="name4" id="name" value="<?php echo $_SESSION['url2']; ?>" required>
                  <label for="name" >URL WHATS APP </label>
                    <input type="text" name="name5" id="name" value="<?php echo $_SESSION['url3']; ?>" required>
  
                    <input type="submit" name="edit_header" value="Edit">
                    <a href="footer.php" class="btn"> Delete </a>
                </form>
              </div>
            </div>
          </div>
...
if (isset($_POST['edit_header'])){
  ...
  if(!empty($_FILES["image"]["name"])) { 
      ...
      if( in_array($file_type, $allowed_file_types) ){ 
          ...
          $query = $conn->query("UPDATE footer SET image='$img_content', text='$name1', ar_text='$name2', url1='$name3',url2='$name4',url3='$name5'   WHERE id = $img_id");
          echo "<script> alert('Footer Section edited.') </script>";
