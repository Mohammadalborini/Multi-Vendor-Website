              ...
              <div class="col-md-12" >
                <div class="card" style="margin-top: 50px;">
                  <div class="card-header">
                    <h4 class="card-title"> Slide Bar Information</h4>
                  </div>
                  <div class="card-body" >
                    <div class="table-responsive" style="overflow: hidden;">
                    <?php
                     $result = $conn->query("SELECT * FROM slide_bar") or die($conn->error);
                   ?>
                      <table class="table" >
                      ...
                      <?php while ($row = $result->fetch_assoc()):?> 
                          ...
                          <td>
                            ...
                            <td>
                             <a href="<?php echo $row['url'];?>" > Button </a>
                            </td>
                            <td class="text-right">
                             <a href="edit_slid bar.php?id=<?php echo $row['id'];?>" class="divs"> Edit</a><br>
                             <a href="slid bar.php?id=<?php echo $row['id'];?>" onclick="javascript: return confirm('Are you sure?');" class="divs" style="background:red;"> Delete</a>
                            </td>
                          </tr>
                          <?php $i++; ?>
                        </tbody>
...
if (isset($_GET['id'])){
  ...
  $result = $conn->query("SELECT * FROM slide_bar WHERE id='$id' ") or die($conn->error);
    while ($row = $result->fetch_assoc()){
      $id = $row['id'];
    $sql = "DELETE FROM slide_bar WHERE id='$id' ";
            mysqli_query($conn, $sql); 
            echo "<script> alert('Slid bar Deleted.') </script>";
}
