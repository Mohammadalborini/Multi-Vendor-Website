                    ...
                    <table class="table" >
                      ...
                      <?php while ($row = $result->fetch_assoc()):?> 
                        ...
                        <?php echo $i; ?>
                          ...
                          <td>
                          <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['weblogo']); ?>"alt="#"/>
                          </td>
                          <td>
                         <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['dashlogo']); ?>"alt="#"/>
                          </td>
                          <td>
                          <?php echo $row['dashname'];?>
                          </td>
                          <td class="text-right">
                           <a href="edit_header.php?id=<?php echo $i ?>" class="divs"> Edit</a>
                          </td>
                        </tr>
                        <?php $i++; ?>
                      </tbody>
