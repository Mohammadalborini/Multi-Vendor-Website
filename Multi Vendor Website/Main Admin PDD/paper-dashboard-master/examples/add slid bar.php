          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Slide Bar Information</h5>
              </div>
              <div class="divs">
                ...
                <label for="name" >Arabic Title </label>
                    <input type="text" name="rname1" id="name" required>
                  <label for="nameo" > Description </label>
                    <input type="text" name="name2" id="nameo" required>
                <label for="nameo" >Arabic Description </label>
                    <input type="text" name="rname2" id="nameo" required>
                  ...
                  <label for="link" > URL link for each slid </label>
...
if (isset($_POST['submit'])){
  ...
  if(!empty($_FILES["image"]["name"])) { 
      ...
      if( in_array($file_type, $allowed_file_types) ){ 
          ...
          $query = $conn->query("INSERT INTO slide_bar(`title`, `ar_title`, `description`, `ar_description`, `image`, `url`) VALUES ('$name1','$rname','$name2','$rname2','$img_content','$link')");
          echo "<script> alert('Slide bar add.') </script>";
