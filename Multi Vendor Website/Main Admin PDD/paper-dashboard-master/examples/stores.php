      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">The stores</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Here is all the stores</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive" style="overflow: hidden;">
                  <?php
                     $result = $conn->query("SELECT * FROM sign_up") or die($conn->error);
                   ?>
                      ...
                      <?php while ($row = $result->fetch_assoc()):?> 
                        <tr>
                         ...
                         <?php echo $i; ?>
                          ...
                          <td>
                          <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['store_logo']); ?>" width="150px" height="auto"  alt="#"/>
                          </td>
                          <td>
                          ...
                          <td>
                          <?php echo $row['first_card'].'<br>'.$row['second_card'].'<br>'.$row['third_card'].'<br>'.$row['fourth_card']   ; ?>
                          </td>
                          <td>
                         <a href="<?php echo $row['location']; ?>" target=_blanck> The Location </a> 
                          </td>
                          <td>
                          <?php
                          $pieces = explode(",", $row['shop_category']);
                    ...
                    <button class="btn" id="btn2" onclick="exportTableToExcel('tbIDate', 'Stores information');">Download this table</button>
                  </div>
                </div>
              </div>
            </div>
