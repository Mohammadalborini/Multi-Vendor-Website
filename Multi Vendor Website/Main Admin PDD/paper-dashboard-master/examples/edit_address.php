...
if (isset($_GET['id'])){
  $id = $_GET['id'];
  $_SESSION['id'] = $id;
  $result = $conn->query("SELECT * FROM address WHERE id='$id' ") or die($conn->error);
    while ($row = $result->fetch_assoc()){
      $_SESSION['address'] =  $row['address']; 
      $_SESSION['price'] =  $row['price']; 
      $_SESSION['promo_code'] =  $row['promo_code']; 
  }}?>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Edit address or promo code</a>
          </div>
            ...
            <div class="card " style="margin-top: 50px;">
              <div class="divs" >
                <form action="" method="POST" enctype="multipart/form-data">
                  <label for="names" > Eidt address  </label><br>
                <label for="nameq" >Address</label>
                    <input type="text" name="question1"  id="nameq" value="<?php echo  $_SESSION['address']; ?>" required>
                <label for="nameq" >Price</label>
                    <input type="text" name="ar_question1"  id="nameq" value="<?php echo  $_SESSION['price']; ?>" required>
                <label for="namea" >Promo code</label>
                <?php
                  if (!($_SESSION['promo_code']) == null) {
                    ...
                    <input type="text" name="question2" id="namea" value="<?php echo  $_SESSION['promo_code']; ?>"><br>
...
if (isset($_POST['submit'])){
          ...
          $query = $conn->query("UPDATE `address` SET `address`='$question1',`price`='$ar_question1',`promo_code`='$question2' WHERE id = $img_id");
          echo "<script> alert('Address edited.') </script>";
