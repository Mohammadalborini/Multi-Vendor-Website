              ...
              <div class="divs">
                <form action="" method="POST" enctype="multipart/form-data">
                  <label for="name" > Title </label>
                    <input type="text" name="name" id="name" value="<?php echo $_SESSION['title']; ?>" required>
                <label for="name1" >Arabic Title </label>
                    <input type="text" name="name1" id="name1" value="<?php echo $_SESSION['ar_title']; ?>" required>
...
if (isset($_POST['submit'])){
  ...
  if(!empty($_FILES["image"]["name"])) { 
      ...
      if( in_array($file_type, $allowed_file_types) ){ 
          ...
          $query = $conn->query("UPDATE offer1 SET  title='$name1', ar_title='$rname',image='$img_content' WHERE id = $img_id");
