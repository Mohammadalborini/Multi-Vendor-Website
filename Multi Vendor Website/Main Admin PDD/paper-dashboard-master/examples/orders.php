      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Order</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Here is all the Orders</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive" style="overflow: hidden;">
                    <table class="table" id="tbIDate"> 
                      ...
                      <tbody>
                        <?php
                        $i=1;
                          $query2="SELECT * from user_product ";
                        ...
                        <tr>
                         ...
                         <?php echo $i; ?>
                          ...
                          <td>
                            <form action="all_oreders.php" method="post">
                              <input type="hidden" name="order" value="<?php echo $id; ?>" >
                              <button type="submit" name="orders" value="View_btn" class="btn btn-primary">View orders</button>
                            </form> 
                          </td>
                        </tr>
                    ...
                    <button class="btn" id="btn2" onclick="exportTableToExcel('tbIDate', 'Orders information');">Download this table</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Order information</h4>
                  <p class="card-category"> Here is orders the user</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive" style="overflow: hidden;">
                    <table class="table" id="tbIDate"> 
                      ...
                      <tbody>
                        <?php
                        $i=1;
                          $query2="SELECT * from user_product where id_user = '$id'";
                          $result2 = mysqli_query($conn,$query2);
                          if (mysqli_num_rows($result2) > 0){
                          while ($row1 = mysqli_fetch_assoc($result2)){
                            $id = $row1['id'];
