              ...
              <div class="col-md-12" >
                <div class="card" style="margin-top: 50px;">
                  <div class="card-header">
                    <h4 class="card-title"> Feedback our partners</h4>
                  </div>
                  <div class="card-body" >
                   ...
                   ?>
                      ...
                      <?php while ($row = $result->fetch_assoc()):?> 
                          <tr>
                            ...
                            <td>
                            <?php echo $row['ar_feedback'];?>
                            </td>
                            <td class="text-right">
                             <a href="feedback.php?id=<?php echo $row['id']; ?>"  onclick="javascript: return confirm('Are you sure?');" class="divs"> Delete</a>
                            </td>
                          </tr>
                          <?php $i++; ?>
                        </tbody>
...
if (isset($_GET['id'])){
  $id = $_GET['id'];
  $result = $conn->query("SELECT * FROM feedback WHERE id='$id' ") or die($conn->error);
