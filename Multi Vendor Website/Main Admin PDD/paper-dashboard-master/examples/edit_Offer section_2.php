...
if (isset($_GET['id'])){
  $id = $_GET['id'];
  $_SESSION['id'] = $id;
  $result = $conn->query("SELECT * FROM offer2 WHERE id='$id' ") or die($conn->error);
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Offer section 2</a>
          </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Offer section 2</h5>
              </div>
              <div class="divs">
                <form action="" method="POST" enctype="multipart/form-data">
                  <label for="name" > Title </label>
                    <input type="text" name="name1" id="name1" value="<?php echo $_SESSION['title']; ?>" required>
                <label for="name1" >Arabic Title </label>
                    <input type="text" name="name2" id="name2" value="<?php echo $_SESSION['ar_title']; ?>" required>
                <label for="name" > Description </label>
                    <input type="text" name="name3" id="name3" value="<?php echo $_SESSION['description']; ?>" required>
                <label for="name1" >Arabic Description </label>
                    <input type="text" name="name4" id="name4" value="<?php echo $_SESSION['ar_description']; ?>" required>
                <label for="utl" >URL button </label>
                    <input type="text" name="utl" id="utl" value="<?php echo $_SESSION['url']; ?>" required>
                  <label for="logo2" > Image </label><br>
                  <img src="data:image/jpg;charset=utf8;base64,<?php echo $_SESSION['image']; ?>" width="150px" height="auto" alt="#"/>
                    <input type="file" name="image" id="logo2" required><p style="color: red;">* the size of image is 1920*840</p>
  
                    <input type="submit" name="submit" value="Save">
                    <a href="Offer section 1 Under slide section.php" class="btn"> Delete </a>
                </form>
              </div>
            </div>
          </div>
...
if (isset($_POST['submit'])){
  ...
  if(!empty($_FILES["image"]["name"])) { 
      ...
      if( in_array($file_type, $allowed_file_types) ){ 
          ...
          $query = $conn->query("UPDATE offer2 SET title='$name1', ar_title='$name2', description='$name3',ar_description='$name4' ,image='$img_content', url='$url' WHERE id = $img_id");
          echo "<script> alert('offer1 edited.') </script>";
            echo '<script> window.location.href = "Offer section 2 Under slide section.php"; </script>';
