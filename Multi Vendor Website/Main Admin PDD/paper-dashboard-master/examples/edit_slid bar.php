...
if (isset($_GET['id'])){
  $id = $_GET['id'];
  $_SESSION['id'] = $id;
  $result = $conn->query("SELECT * FROM slide_bar WHERE id='$id' ") or die($conn->error);
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Slide bar</a>
          </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Slid bar section Information</h5>
              </div>
              <div class="divs">
                <form action="" method="POST" enctype="multipart/form-data">
                <label for="logo2" > Slide bar image </label><br>
                  ...
                  <label for="name" > Title </label>
                    <input type="text" name="name1" id="name" value="<?php echo $_SESSION['title']; ?>" required>
                  <label for="name" >Arabic title </label>
                    <input type="text" name="name2" id="name" value="<?php echo $_SESSION['ar_title']; ?>" required>

                  <label for="name" >Description </label>
                    <input type="text" name="name3" id="name" value="<?php echo $_SESSION['description']; ?>" required>
                  <label for="name" >Arabic Description </label>
                    <input type="text" name="name4" id="name" value="<?php echo $_SESSION['ar_description']; ?>" required>
                  <label for="name" >URL Button </label>
                    <input type="text" name="name5" id="name" value="<?php echo $_SESSION['url']; ?>" required>
  
                    <input type="submit" name="edit_slid" value="Edit">
                    <a href="slid bar.php" class="btn"> Delete </a>
                </form>
              </div>
            </div>
          </div>
...
if (isset($_POST['edit_slid'])){
  ...
  if(!empty($_FILES["image"]["name"])) { 
      ...
      if( in_array($file_type, $allowed_file_types) ){ 
          ...
          $query = $conn->query("UPDATE slide_bar SET  title='$name1', ar_title='$name2', description='$name3',ar_description='$name4', image='$img_content', url='$name5'   WHERE id = $img_id");
          echo "<script> alert('Slid bar edited.') </script>";
          echo '<script> window.location.href = "slid bar.php"; </script>';
