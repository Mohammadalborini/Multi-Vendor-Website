...
if (isset($_GET['id'])){
  $id = $_GET['id'];
  $_SESSION['id'] = $id;
  $result = $conn->query("SELECT * FROM security_info WHERE id='$id' ") or die($conn->error);
    while ($row = $result->fetch_assoc()){
    $_SESSION['text'] =  $row['title'];
    $_SESSION['ar_text'] =  $row['ar_title'];
...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Security</a>
          </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Security section Information</h5>
              </div>
              <div class="divs">
                <form action="" method="POST" enctype="multipart/form-data">
                  <label for="name" > Title </label>
                    <input type="text" name="name1" id="name" value="<?php echo $_SESSION['text']; ?>" required>
                  <label for="name" >Arabic title </label>
                    <input type="text" name="name2" id="name" value="<?php echo $_SESSION['ar_text']; ?>" required>
                  ...
                  <label for="name" >Arabic Description </label>
                    ...
                    <a href="Security.php" class="btn"> Delete </a>
                </form>
              </div>
            </div>
          </div>
  ...
  <script>
    ...
    var new_input="<label id='new_"+new_chq_no+"' style='width:100%;'> <label for='nameq' >Question</label><input type='text' name='question[]'  required><label for='namea' >Answer</label><input type='text' name='answer[]' id='new_"+new_chq_no+"' required> <br><hr> </label>";
...
if (isset($_POST['edit_header'])){
          ...
          $query = $conn->query("UPDATE security_info SET title='$name1', ar_title='$name2', description='$name3', ar_description='$name4' WHERE id = $img_id");
          echo "<script> alert('Security Section edited.') </script>";
