              ...
              <div class="col-md-12" >
                <div class="card" style="margin-top: 50px;">
                  ...
                  <div class="card-body" >
                    ...
                    <?php
                     $result = $conn->query("SELECT * FROM security_info") or die($conn->error);
                   ?>
                      <table class="table" >
                      ...
                      <?php while ($row = $result->fetch_assoc()):?> 
                          <tr>
                            ...
                            <td class="text-right">
                             <a href="edit_Security_info.php?id=<?php echo $row['id']; ?>"  class="divs">  Edit</a>
                            </td>
                          </tr>
                          <?php $i++; ?>
                          <?php endwhile; ?>
                ...
                <div class="card" style="margin-top: 50px;">
                  ...
                  <div class="card-body" >
                    <div class="table-responsive" style="overflow: hidden;">
                    <?php
                     $result = $conn->query("SELECT * FROM security_image") or die($conn->error);
                   ?>
                      <table class="table" >
                        <thead class=" text-primary">
                          <th>
                      ...
                      <?php while ($row = $result->fetch_assoc()):?> 
                          <tr>
                            ...
                            <td class="text-right">
                             <a href="edit_Security_image.php?id=<?php echo $row['id']; ?>"  class="divs"> Edit</a>
                            </td>
                          </tr>
                          <?php endwhile; ?>
                        </tbody>
