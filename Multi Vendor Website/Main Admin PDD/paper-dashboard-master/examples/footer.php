                   ...
                   ?>
                      ...
                      <?php while ($row = $result->fetch_assoc()):?> 
                          <tr>
                            ...
                            <td>
                            <?php echo $row['ar_text'];?>
                            </td>
                            <td>
                              <a href="" target="_blank"> <?php echo $row['url1'];?></a>
                            </td>
                            <td>
                              <a href="" target="_blank"> <?php echo $row['url2'];?></a>
                            </td>
                            <td>
                              <a href="" target="_blank"> <?php echo $row['url3'];?></a>
                            </td>
                            <td class="text-right">
                             <a href="edit_footer.php?id=<?php echo $i;?>"  class="divs"> Edit</a>
                            </td>
                          </tr>
                          <?php $i++; ?>
                        </tbody>
