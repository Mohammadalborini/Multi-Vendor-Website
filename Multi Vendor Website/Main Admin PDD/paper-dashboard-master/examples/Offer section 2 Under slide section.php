            ...
            <div class="card">
              ...
              <div class="divs">
                ...
                <label for="name" >Arabic Title </label>
                  ...
                  <label for="named" > Description </label>
                    <input type="text" name="name3" id="named" required>
                <label for="named" >Arabic Description </label>
                    <input type="text" name="name4" id="named" required>
                    <label for="url" >URL button </label>
              ...
              <div class="col-md-12" >
                <div class="card" >
                  <div class="card-body" >
                    ...
                    <?php
                     $result = $conn->query("SELECT * FROM offer2") or die($conn->error);
                   ?>
                      <table class="table" >
                      ...
                      <?php while ($row = $result->fetch_assoc()):?> 
                          ...
                          <?php echo $i;?>
                            ...
                            <td>
                            <?php echo $row['ar_description'];?>
                              </td>
                              <td>
                            <a href="<?php echo $row['url'];?>">URL button</a>
                              </td>
                            <td>
                            <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['image']); ?>" width="150px" height="auto"  alt="#"/>
                            </td>
                            <td class="text-right">
                            <a href="edit_Offer section_2.php?id=<?php echo $row['id'];?>" class="divb"> Edit</a><br><br><br>
                             <a href="Offer section 2 Under slide section.php?id=<?php echo $row['id'];?>" onclick="javascript: return confirm('Are you sure?');" class="divb" style="background:red;"> Delete</a>
                            </td>
                          </tr>
                          <?php $i++; ?>
                        </tbody>
...
if (isset($_POST['submit1'])){
  ...
  if(!empty($_FILES["image"]["name"])) { 
      ...
      if( in_array($file_type, $allowed_file_types) ){ 
          ...
          $query = $conn->query("INSERT INTO `offer2`( `title`, `ar_title`, `description`, `ar_description`, `image`, 'url') VALUES ('$name1','$name2','$name3','$name4','$img_content','$url')");
...
if (isset($_GET['id'])){
  ...
  $result = $conn->query("SELECT * FROM offer2 WHERE id='$id' ") or die($conn->error);
    while ($row = $result->fetch_assoc()){
      $id = $row['id'];
    $sql = "DELETE FROM offer2 WHERE id='$id' ";
