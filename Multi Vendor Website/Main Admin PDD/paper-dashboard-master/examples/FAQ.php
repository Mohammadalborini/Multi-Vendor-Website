      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Footer : Q&A</a>
          </div>
              ...
              <div class="col-md-12" >
                <div class="card" style="margin-top: 50px;">
                  <div class="card-header">
                    <h4 class="card-title"> FAQ : Q&A </h4>
                  </div>
                  <div class="card-body" >
                    <div class="table-responsive" style="overflow: hidden;">
                    <?php
                     $result = $conn->query("SELECT * FROM faq") or die($conn->error);
                   ?>
                      <table class="table" >
                      ...
                      <?php while ($row = $result->fetch_assoc()):?> 
                          ...
                          <?php echo $i;?>
                            ...
                            <td>
                            <?php echo $row['ar_question'];?>
                            </td>
                            <td>
                            <?php echo $row['answer'];?>
                             <br>
                             <?php
                             if (!($row['ans_video']) == null) {
                               $video= $row['ans_video'];
                                echo '
                            ...
                            <td>
                            <?php echo $row['ar_answer'];?>
                            </td>
                            <td class="text-right">
                             <a href="edit_FAQ.php?id=<?php echo $row['id']; ?>" class="divs"> Edit</a><br>
                             <a href="FAQ.php?id=<?php echo $row['id'];?>" onclick="javascript: return confirm('Are you sure?');" class="divs" style="background:red;"> Delete</a>
                            </td>
                          </tr>
                          <?php $i++; ?>
                          <?php endwhile; ?>
