            ...
            <div class="card " style="margin-top: 50px;">
              <div class="divs" >
                ...
                <label for="nameq" >Question</label>
                    <input type="text" name="question1"  id="nameq" required>
                <label for="nameq" >Arabic Question</label>
                    <input type="text" name="ar_question1"  id="nameq" required>
                <label for="namea" >Answer (text or video)</label>
                    <input type="text" name="question2" id="namea" required><br>
                    <input type="file" name="file" id="namea" ><br>
                    <p style="color: red;">* Please insert mp4</p>

                    <label for="namea" >Arabic Answer</label>
                    <input type="text" name="ar_question2" id="namea" required><br>
          ...
          if (in_array($fileActualExt, $allowed)) {
              if ($fileError === 0) {
                ...
                $ar_question2 = $_POST['ar_question2'];
                 ...
                 $query = $conn->query("INSERT INTO `faq`( `question`, `ar_question`, `answer`, `ar_answer`, `ans_video`) VALUES ('$question1','$ar_question1','$question2',' $ar_question2','$fileNameDB')");
                 echo "<script> alert('FAQ add.') </script>";
