            ...
            <div class="card">
              ...
              <div class="divs">
                ...
                <label for="logo2" >Dashboard Logo </label><br>
                    ...
                    <input type="file" name="image1" id="logo2" required><p style="color: red;">* the size of image is 127*27</p>
                  <label for="name" > Dashboard name </label>
                    ...
                    <a href="header.php" class="btn"> Delete </a>
                </form>
              </div>
            </div>
          </div>
  ...
  if(!empty($_FILES["image"]["name"])) { 
    ...
    if(!empty($_FILES["image1"]["name"])) { 
      ...
      if( in_array($file_type, $allowed_file_types) ){ 
          ...
          $query = $conn->query("UPDATE header SET dashname='$dashname', weblogo = '$img_content', dashlogo='$img_content1'   WHERE id = $img_id");
