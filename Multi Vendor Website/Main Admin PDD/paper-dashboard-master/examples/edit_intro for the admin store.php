...
if (isset($_GET['id'])){
  $id = $_GET['id'];
  $_SESSION['id'] = $id;
  $result = $conn->query("SELECT * FROM upload_video WHERE id='$id' ") or die($conn->error);
    while ($row = $result->fetch_assoc()){
    $_SESSION['viedo'] =  $row['viedo'];  
  }}?>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Upload video to admin store</a>
          </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">edit Viedo to admin store</h5>
              </div>
              <div class="divs">
                <form action="" method="POST" enctype="multipart/form-data">
                <label for="logo2" > Viedo </label><br>
                <video width="320" height="240" controls>
                        <source src="../upload/<?php echo  $_SESSION['viedo'];?>" type="video/mp4">

                </video> 
                    <input type="file" name="file" id="logo2" required>
                    <input type="submit" name="edit_video" value="Edit">
                    <a href="intro for the admin store.php" class="btn"> Delete </a>
                </form>
              </div>
            </div>
          </div>
...
if (isset($_POST['edit_video'])){
          ...
          if (in_array($fileActualExt, $allowed)) {
              if ($fileError === 0) {
                 if ($fileSize < 20000000) {
                   ...
                   $fileNameDB= "store.mp4";
                    
                   $fileNameNew=  "store".'.'.$fileActualExt;
                   ...
                   $query = $conn->query("UPDATE upload_video SET viedo= '$fileNameDB' WHERE id = $img_id");
                   echo "<script> alert('Viedo edited.') </script>";
                   echo '<script> window.location.href = "intro for the admin store.php"; </script>';
  ...
  echo "<script> alert('Pleace isert video mp4.') </script>";
}
