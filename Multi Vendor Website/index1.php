...
if (!isset($_SESSION["lang"])) { $_SESSION["lang"] = "en";  header("Location: index1.php");}
if (isset($_POST["lang"])) { $_SESSION["lang"] = $_POST["lang"];  header("Location: index1.php");}

require "lang/index1-".$_SESSION["lang"].".php";
...
<section class="bg-light position-relative">
    <div class="main-slider dots-style theme1">
            ...
            while ($row = mysqli_fetch_assoc($result)):
            $title = $row[$_TXT[66]];
            $description = $row[$_TXT[67]];
            $image = $row['image'];
            $url = $row['url'];
            
            
            ?>
        <div class="slider-item bg-img bg-img1" style="
        background-image: url('data:image/jpg;charset=utf8;base64,<?php echo base64_encode($image); ?>')">
            <div class="container">
                    ...
                    <div class="col-12">
                        <div class="slider-content">
                            <p class="text text-dark text-uppercase animated mb-25" data-animation-in="fadeInDown">
                                <?php echo $title; ?></p>
                            <h4 class="title text-dark animated text-capitalize mb-20" data-animation-in="fadeInLeft"
                                data-delay-in="1"><?php echo $description; ?></h4>
                            <a href="<?php echo $url; ?>"
                                class="btn theme--btn1 btn--lg text-uppercase  animated mt-45 mt-sm-25"
                                data-animation-in="zoomIn" data-delay-in="3"><?= $_TXT[68]; ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="common-banner pt-70 bg-white">
    <div class="container">
        <div class="row">
                    <?php  
            $query="SELECT * from offer2";
            $result = mysqli_query($conn,$query);
            if (mysqli_num_rows($result) > 0):
            while ($row = mysqli_fetch_assoc($result)):
            $title1 = $row[$_TXT[69]];
            $description1 = $row[$_TXT[70]];
            $image1 = $row['image'];
            $url1= $row['url']
            ?>
            <div class="col-md-6 mb-30">
                <div class="position-relative zoom-in overflow-hidden">
                    <div class="banner-thumb">
                        <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($image1); ?>" alt="banner-thumb-naile">
                    </div>
                    <div class="banner-content">
                        <p class="text text-capitalize text-dark mb-10"><?php echo $title1 ?></p>
                        <h4 class="title text-capitalize text-dark"><?php echo $description1; ?></h4>
                        <a class="view-link text-capitalize mt-20" href="<?php echo $url1; ?>"><?= $_TXT[71]; ?>
...
<section class="product-tab bg-white pt-40 pb-70">
    <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="section-title text-center mb-30">
                        <h2 class="title text-dark text-capitalize mb-20"><?= $_TXT[72]; ?></h2>
                        <p class="text"><?= $_TXT[73]; ?></p>
                    </div>
                </div>
                <div class="col-12">
                    <nav class="product-tab-menu theme1">
                        <ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" id="pills-home-tab" href="#pills-home"><?= $_TXT[74]; ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-profile-tab" href="#pills-profile"><?= $_TXT[75]; ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-contact-tab"  href="#pills-contact"><?= $_TXT[76]; ?> </a>
                            </li>
                        </ul>
                    </nav>
                </div>
        ...
        <!-- product-tab-nav end -->
        <h1 style="padding: 25px; text-align: center;" id="pills-home"><?= $_TXT[77]; ?></h1>
        ...
        $query="SELECT * from orders order by numer_seller DESC limit 6";
        $result = mysqli_query($conn,$query);
        if (mysqli_num_rows($result) > 0):
        ...
        ?>
                            <div class="slider-item">
                             ...
                             if (!($discount) == null) {
                              ...
                              $new_dis = (1-($discount/$product_price)) * 100 ;
                                echo '  <span class="badge badge-success top-left">-'.round($new_dis, 0).'%</span>';
                            ...
                            <?php
                                  $uploaded_on = date_create($uploaded_on);
                                        ...
                                        echo ' <span class="badge badge-danger top-right">'.$_TXT[86].'</span>';
                                        }
                                        ?> 
                                              <a class="d-block" href="single-product-configurable.php?id_store=<?php echo $store_id?>&id_product=<?php echo $id;  ?>&storename=<?php echo $store_name; ?>">
                                                <?php
                                        ...
                                        ?>  
                                                ...
                                                <ul class="d-flex justify-content-center">
                                                        <li>
                                                            <a href="cart.php?id1=<?php echo $id1; ?>&id=<?php echo $id;?>">
                                                                <span data-toggle="tooltip" data-placement="bottom" title="<?= $_TXT[83]; ?>" class="ion-bag"   data-original-title="Add to cart"></span>
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <a href="Favorite.php?id1=<?php echo $id1; ?>&id=<?php echo $id;?>">
                                                                <span data-toggle="tooltip" data-placement="bottom"
                                                                    title="<?= $_TXT[85]; ?>"
                                            ...
                                            <div class="media-body">
                                                <div class="product-desc">
                                                    ...
                                                    <h3 class="title my-10"><a href="single-product-configurable.php?id_store=<?php echo $store_id?>&id_product=<?php echo $id;  ?>&storename=<?php echo $store_name; ?>"><?php echo $product_name1; ?></a></h3>
                                                    <a href="shop-grid-4-column-store.php?id_store=<?php echo $store_id ?>&store-name=<?php echo $store_name; ?>&rele=rele"> <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($store_logo); ?>" style="width:50px; height:auto;"></a>
                                                    <?php
                                                        if (!($discount) == null) {
                                                        echo '<h6 class="product-price"><del class="del">'.$product_price.' '.$_TXT[81].'</del>
                                                        <span class="onsale">'.$discount.' '.$_TXT[81].'</span></h6>';
                                                        }else {
                                                            echo '<h6 class="product-price"> <span class="onsale">'.$product_price.' '.$_TXT[81].'</span></h6>';
                                                        }
                                                        ?>
                                                </div>
                                            </div>
        ...
        <h1 style="padding: 25px; text-align: center;" id="pills-profile"><?= $_TXT[79]; ?></h1>
        <div class="row" style="margin-bottom: 300px;">
            <div class="col-12">
                <div class="tab-content" id="pills-tabContent">
        ...
        <h1 style="padding: 25px; text-align: center;" id="pills-contact"><?= $_TXT[80]; ?></h1>
        <div class="row">
            <div class="col-12">
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" role="tabpanel"
        ...
        $query="SELECT * from orders where discount is not null limit 6";
        $result = mysqli_query($conn,$query);
        if (mysqli_num_rows($result) > 0):
            $sum = mysqli_num_rows($result);
        while ($row = mysqli_fetch_assoc($result)):
    ...
    <?php else: echo '<h6 class="product-price"> <span class="onsale">'.$_TXT[82].' </span></h6>'; ?>
<?php endif;?>
                        </div>
                    </div>   
                </div>
...
<section class="testimonial-section pb-70">
    <div class="container">
        ...
        $title = $row[$_TXT[87]];
        $image = $row['image'];
        $feedback = $row[$_TXT[88]];
        $email = $row['email'];
        ?>
                    <div class="slider-item">
                        <div class="testimonial-content text-center">
                            <img class="mb-30 mx-auto" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($image); ?>" alt="user">
                            <p> <?php echo $feedback; ?> </p>
                            <span class="ion-quote mt-15 mb-30"></span>
                            <h4 class="text-uppercase mb-15"><?php echo $name ?></h4>
                            <a class="text-capitalize" href="mailto:<?php echo $email; ?>"><?php echo $email; ?></a>
                        </div>
                    </div>
