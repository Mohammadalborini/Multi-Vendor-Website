...
if (!isset($_SESSION["lang"])) { $_SESSION["lang"] = "en";  header("Location: Favorite.php");}
if (isset($_POST["lang"])) { $_SESSION["lang"] = $_POST["lang"];  header("Location: Favorite.php");}

require "lang/Favorite-".$_SESSION["lang"].".php";
...
<nav class="breadcrumb-section theme1 breadcrumb-bg1" style="
        background-image: url('data:image/jpg;charset=utf8;base64,<?php echo base64_encode($image8); ?>')">
  <div class="container">
    <div class="row">
      <div class="col-12">
...
<section class="whish-list-section theme1 pb-70">
    <div class="container grid-wraper">
        <div class="row">
            <div class="col-12">
                <h3 class="title pb-30 text-center text-md-left text-capitalize"><?= $_TXT[69]; ?></h3>
...
if (!isset($_SESSION['id1'])){
  ...
  $query5="SELECT * from favorite where id_user = '$id1' and id_product = '$id'  ";
  $result5 = mysqli_query($conn,$query5);
  if (mysqli_num_rows($result5) > 0){
    ...
    $query="INSERT INTO `favorite`(`id_user`, `id_product`,`store_id`, `product_image`, `product_name`,`ar_product_name`, `store_logo`, `store_name`,`ar_store_name`, `price`) VALUES
     ('$id1','$id','$store_id','$piece','$product_name','$ar_product_name','$store_logo','$store_name','$ar_store_name','$price');";
                ...
                <div class="table-responsive">
                    <table class="table mb-0">
                        <thead class="thead-light">
                            <tr>
                                <th class="text-center" scope="col"><?= $_TXT[74]; ?></th>
                        ...
                        <?php
                          ...
                          ?>
                            <tr>
                                ...
                                <th class="text-center" scope="row">
                                <a href="shop-grid-4-column-store.php?id_store=<?php echo $store_id1; ?>&store-name=<?php echo $store_name; ?>&rele=rele">
                                ...
                                <td class="text-center">
                                    <span class="badge badge-danger position-static my-badge"><?= $_TXT[85]; ?></span>
                                </td>
                                <td class="text-center">
                                    <span class="whish-list-price">
                                        <?php echo $price ?> <?= $_TXT[86]; ?>
                                    </span></td>
                                ...
                                <td class="text-center">
                                    <a href="checkout.php?id_product=<?php echo $id_product1; ?>&qty=<?php echo $qty; ?>" class="btn theme-btn--dark1 btn--xl text-uppercase"><?= $_TXT[87]; ?></a>
                                </td>
                            </tr>
                            <?php }
                            }else {
                              echo '<h3 class="title pb-25 text-center text-md-left text-capitalize">'.$_TXT[88].'</h3>';
                            }
                             ?>
                        </tbody>
                    </table>
...
if (mysqli_num_rows($result4) > 0){
  ...
  echo '<script> window.location.href = "Favorite.php?true=true"; </script>';
}
}
