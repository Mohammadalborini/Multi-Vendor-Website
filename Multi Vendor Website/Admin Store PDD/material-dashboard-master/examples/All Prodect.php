...
require "lang/all-".$_SESSION["lang"].".php";
      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <div class="col-md-12">
            ...
            <div class="card-body">
            <?php
                     $result = $conn->query("SELECT * FROM orders where store_id = $id1") or die($conn->error);
                   ?>
            <table class="table">
                ...
                <tr>
                  ...
                  <td >
                  <a href="view_product.php?username=<?php echo $username; ?>&id_product=<?php echo $row['id']; ?>" class="btn btn-primary" ><?=$_TXT[25]?></a>


                  <a href="All Prodect.php?username=<?php echo $username; ?>&id=<?php echo $row['id']; ?>&store_id=<?php echo $row['store_id']; ?>" onclick="javascript: return confirm('Are you sure?');" class="btn btn-danger" ><?=$_TXT[26]?></a>
                  </td>
                </tr>
                <?php $i++; ?>
                <?php endwhile; ?>
