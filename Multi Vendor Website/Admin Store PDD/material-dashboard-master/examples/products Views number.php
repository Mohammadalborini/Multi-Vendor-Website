...
require "lang/view-".$_SESSION["lang"].".php";
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper" >
            <a class="navbar-brand" href="javascript:;" ><?=$_TXT[21]?></a>
          </div>
        ...
        <div class="container-fluid">
          ...
          <div class="col-md-12">
            ...
            <div class="card-header card-header-primary">
              <h4 class="card-title" style="text-align:<?=$_TXT[13]?>;"><?=$_TXT[25]?></h4>
            </div>
            <div class="card-body">
            <table class="table">
                ...
                <tbody>
                  <?php
                  $i = 0;
                  $query="SELECT * from orders where store_id = '$id' ";
                  $result = mysqli_query($conn,$query);
                  if (mysqli_num_rows($result) > 0):
                      $sum = mysqli_num_rows($result);
                  while ($row = mysqli_fetch_assoc($result)):
                    $product_name = $row['product_name'];
                    $views_product = $row['views_product'];
                   ?>
                <tr>
                  <td>
                  <?php echo $i; ?>
