                  ...
                  <div class="table-responsive">
                    <table class="table" id="tbIDate"> 
                      ...
                      <tbody>
                        <?php
                          $i = 1;
                         $query1="SELECT * from user_product where id_store = '$id' ";
                        ...
                        <tr>
                         ...
                         <?php echo $user_name; ?>
                          ...
                          <td>
                            <form action="all_order.php" method="post">
                              <button type="submit" name="View_btn" value="View_btn" class="btn btn-primary"> <?=$_TXT[31]?></button>
...
if (isset($_GET['id'])){
  ...
  $query="UPDATE `user_product` SET `pointer1`='1' WHERE id = '$id2' ";
  $result = mysqli_query($conn,$query);
}
?>